...
const ForgetPassword = () => {
  ...
  return (
    ...
    >
      <div className="p-8">
        <h2 className="text-3xl font-bold mb-6 text-center bg-gradient-to-r from-violet-400 to-blue-500 text-transparent bg-clip-text">
          Forgot Password
        </h2>
        ...
        {!isSubmitted ? (
          <form onSubmit={handleSubmit}>
            <p className="text-gray-300 mb-6 text-center">
              Enter your <u className="decoration-indigo-500 decoration-dashed decoration-2">registered</u> email address and we'll send you a link to reset your
              password.
            </p>
            <Input
              icon={Mail}
